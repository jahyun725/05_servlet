package com.my.chap05cookiesessionlecturesource.section02.session;
...
public class SessionHandler extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    * - 이후 요청 시 클라이언트의 쿠키(Session ID)를 받아와서
    *   서버에 Session ID가 일치하는 Session 객체가 있는 지 확인
    *   -> 있으면 해당 객체를 반환해서 활용
    *       (반환받은 객체에 값이 세팅되어있다면 활용 가능 == 상태 유지)
