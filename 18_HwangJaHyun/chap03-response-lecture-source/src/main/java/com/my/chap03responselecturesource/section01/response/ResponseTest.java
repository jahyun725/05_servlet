package com.my.chap03responselecturesource.section01.response;
...
public class ResponseTest extends HttpServlet {
   ...
   * 3. 응답을 처리한다.
   * => resp를 이용해서 결과 웹을 만들고(동적 웹)
   *    스트림을 통해서 클라이언트에게 출력
   * */
  @Override
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    // System.out.println(1/0); // 500 에러
    ...
    printWriter.write(sb.toString()); // html 코드 출력하기
    printWriter.flush();
    printWriter.close();
  }
}
