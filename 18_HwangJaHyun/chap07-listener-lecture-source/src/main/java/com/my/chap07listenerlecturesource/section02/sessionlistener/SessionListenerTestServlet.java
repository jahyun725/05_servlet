package com.my.chap07listenerlecturesource.section02.sessionlistener;
...
public class SessionListenerTestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("user", new com.my.chap07listenerlecturesource.section02.sessionlistener.UserDTO("honggildong", 20));
